...
namespace UserRegTesting
{
    ...
    public class UserRegTestCases
    {
        ...
        [TestMethod]
        [DataRow("Raji", "Raji")]
        [DataRow("raji", "First Name is not Valid")]
        [DataRow("", "First Name is not Valid")]
        public void TestFirstName(string userInput, string expected)
        {
            ///Act
            string actual = REGEXPattern.ValidateFirstName(userInput);
        ...
        {
            ///Act
            string actual = REGEXPattern.ValidateLastName(userInput);
        ...
        {
            ///Act
            string actual = REGEXPattern.ValidateEmail(userData);
        ...
        { 
            ///Act
            string actual = REGEXPattern.ValidateMobileNumber(userInput);
            ///Asert
            Assert.AreEqual(expected, actual);
        }
        ...
        {
            ///Act
            string actual = REGEXPattern.ValidatePassword(userInput);
            ///Asert
            Assert.AreEqual(expected, actual);
        }
    }
